...
- **Report ID**: CHECKER-OUTPUT-20260315-001
...
|--------|-----------|----------|-------------------|-------------|-------------|---------------|
| 1 | DS3.1 | 2026-03-15 14:30:00 | 4.8 | 15 | 0 | 3 |
...
### 11.1 Summary
- **Validation Outcome**: All 15 test cases passed validation with excellent quality using DS3.1 LLM validator
